...
ratio_test = 0.6
degree_step = 10
methods = ['myKMeans_eachSubClass_','LDA_eachSubClass_','KNN_eachSubClass_','SVM_eachSubClass_']
...
with open('outfile_kmeans_for_each_subclass_allfold_40_cos_','wb') as fp:
    pickle.dump(final_res,fp)
with open('outfile_kmeans_for_each_subclass_40_cos_','wb') as fp:
    pickle.dump(ave_final_res,fp)
with open('outfile_kmeans_for_each_subclass_40_cos_', 'rb') as fp:

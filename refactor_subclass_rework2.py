            ...
            for xlarge in p1.iterate(xlarges):
                ...
                with pymp.Parallel(len(pca_keeps)) as p2:
                    for pca_keep in p2.iterate(pca_keeps):
                        print p.thread_num, p1.thread_num,p2.thread_num
                        foldres = []
                        fold_topk_res = []
                        ...
                        for method in p.iterate(methods):
                        ...
                        for method in p.iterate(methods_top_k):
                        ...
                        #with p.lock:
                        res_fold.append([xlarge,pca_keep,temp_foldres,temp_fold_topk_res])
...
with open('outfile_rework_2','wb') as fp:
    pickle.dump(ave_final_res,fp)
with open('outfile_rework_2', 'rb') as fp:
